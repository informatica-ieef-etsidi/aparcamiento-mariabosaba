...
#define N 10//Se supone que 5 son para moto y otras 5 para coche.
#define NUSUARIOS 5
/*Modifica el programa para que funcione para un aparcamiento de N plazas(utilice una constante para definir el valor de NPLAZAS).Utiliza un vector de estructuras.
